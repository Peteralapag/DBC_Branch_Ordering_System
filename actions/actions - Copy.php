...
if($mode == 'submitorder')
{
	...
	$queryDataUpdate = "UPDATE dbc_order_request SET status='Approval',checked='Approved',status='Submitted', approved='Approved',checked_by='$user',checked_date='$dateNow',approved_by='$approvedby',approved_date='$dateNow' WHERE control_no='$control_no'";
	if ($db->query($queryDataUpdate) === TRUE)
	{
		print_r('
			<script>
