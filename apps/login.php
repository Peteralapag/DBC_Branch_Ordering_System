...
<div class="login-wrapper">
	...
	<div style="margin-top:10px;text-align:center;margin-bottom:40px"><span class="register" onclick="registerUser()"><i class="fa fa-cube" aria-hidden="true"></i>&nbsp;&nbsp;DBC Branch Registration</span></div>
...
function registerUser()
{
	...
	$.post("../Modules/User_Management/register/DBC_register_form.php", {  },
	function(data) {
