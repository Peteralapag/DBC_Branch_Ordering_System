...
.form-wrapper {width:420px;height:auto;overflow-y:auto; position:relative; margin-bottom:10px}
.table th {font-size:14px !important; vertical-align:middle}
...
<div class="form-wrapper">
	<table style="width: 100%" class="table">
		...
		<tr>
			<th>Recipient:</th>
			<td>
				<select id="reci_pient" class="form-control" disabled>
	...
	<?php if($request_type == 'new') { ?>
		<button class="btn btn-success" onclick="generateRequest('new')">Generate Request</button>
