...
<div class="smnav-header">
	...
	<?php } else { ?>
	<div class="search-shell" style="margin-left:0px;width:;">
...
$(function()
{
	...
	$('#search').keyup(function()
	{
		...
		$.post("./Modules/" + module + "/includes/order_tracking_data.php", { limit: limit, search: search, branch: branch },
		function(data) {
			$('#smnavdata').html(data);
		});
...
function load_data()
{
	...
	var limit = $('#limit').val();
	rms_reloaderOn("Loading data...");
	$.post("./Modules/" + module + "/includes/order_tracking_data.php", { limit: limit },
	function(data) {
		$('#smnavdata').html(data);
		rms_reloaderOff();
	});
